    ...
    public partial class TraitBan : BaseUnityPlugin {
        ...
        private void Awake() {
            ...
            configTraits = new Dictionary<string, ConfigItem<bool>> {
                ...
                { "Gay",                    new ConfigItemBool( this.Config, "Traits", "Gay",                    "Nature - Being true to being you. (No effect)",                                                                                   true ) },
                ...
                { "YouAreBlue",             new ConfigItemBool( this.Config, "Traits", "YouAreBlue",             "Methemoglobinemia/Blue - You are blue. (No effect)",                                                                              true ) },
