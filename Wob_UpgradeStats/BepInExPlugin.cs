    ...
    public partial class BepInExPlugin : BaseUnityPlugin {
        ...
        private void Awake() {
            ...
            configSkills = new Dictionary<string, ISkillConfig> {
                ...
                { "Gold_Saved_Amount_Saved",   new SkillConfigF( this.Config, "Upgrades", "Gold_Saved_Amount_Saved",   "Scribe's Office - Increase Living Safe's Gold Conversion. +X% Gold per rank",                                                                            4f,   0.1f, 4.5f,           0.01f ) },
                ...
                { "Magic_Crit_Chance_Flat_Up", new SkillConfigF( this.Config, "Upgrades", "Magic_Crit_Chance_Flat_Up", "The Quantum Observatory - Increases the chance of random Magic Crits. Adds a chance for Magic Crits to become Super Crits. +X% Crit Chance per rank",    1f,   0.1f, 4f,             0.01f ) },
